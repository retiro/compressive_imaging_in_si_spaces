function [ y ] = mfSensOperator_randSubsampWhtGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, varargin )
...
%  -----
%
%   y = mfSensOperator_randSubsampWhtGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, 'wname')
%   or
%   y = mfSensOperator_randSubsampWhtGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, LoR, HiR)
%
%  Input
%  -----
