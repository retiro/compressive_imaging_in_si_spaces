function [ y ] = mfSensOperator_randSubsampFftGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, varargin )
% Matrix free sensing operator
%
% Phi - random subsampling, discrete Fourier transform, global randomizer
% Psi - discrete wavelet transform
%
%  Usage
%  -----
%
%   y = mfSensOperator_randSubsampFftGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, 'wname')
%   or
%   y = mfSensOperator_randSubsampFftGlobalRand_dwt( x, s, mode, picks, perm, permReturn, r_sa, LoR, HiR)
%
%  Input
%  -----
...
switch mode
    case 1
        ...
        y_all = fft(SIsamples_perm)./sqrt(n);
    ...
    case 2
        ...
        SIsamples_perm = ifft(y_all).*sqrt(n);
